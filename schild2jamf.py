...
def export_users_to_csv(users, file_name):
    with open(file_name, mode="w", newline="") as file:
        ...
        # Write user data
        for user in users:
            writer.writerow([user.given, user.name, user.username, user.email])
...
def export_groups_to_csv(groups, file_name):
    with open(file_name, mode="w", newline="") as file:
        ...
        # Write CSV header
        writer.writerow(["groupid", "parent", "name", "alt_name"])
...
if __name__ == "__main__":
    ...
    # Export users to csv
    export_users_to_csv(users, "users20241007.csv")

    # Export groups to csv
    export_groups_to_csv(groups, "groups20241007.csv")
